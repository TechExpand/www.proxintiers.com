...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>Broadtrademining | Online Forex, Crypto Currency Investment And Trading Platform.</title>
    <meta property="og:title" content="Welcome To Broadtrademining" />
    <meta property="og:site_name" content="Broadtrademining" />
    <meta property="og:description"
        content="Broadtrademining is a fully automated trading platform that gives you full control of your investment, and allows you to withdraw your capital and profit at anytime, depending on the plan chosen!." />
    ...
    _smartsupp.key = '7741f783edebc6da907fb30246a8d6114c53034f';
...
<body id="bg">
    ...
    <div class="page-wraper">
        ...
        <!-- HEADER START -->
        <header class="site-header header-style-3 topbar-transparent" style="overflow-x: hidden;">
                    ...
                    <div class="row">
                        <div class="clearfix mobile">
                            <div style="display: flex; justify-content:space-between;">
                                ...
                                <button style="margin-top: -5px !important;" data-target=".header-nav"
                                ...
                                <ul class="list-unstyled e-p-bx pull-right" style="margin-right: 1rem;">
                                    <li><a href="/login"><i class="fa fa-user"></i>Login</a></li>
                                    <li><a href="/register"><i class="fa fa-sign-in"></i>Register</a></li>

                                    <li style="padding-top: 4rem;" id="google_translate_element">
                    ...
                    <div class="container">
                        ...
                        <div class="logo-header">
                            <a href="/">
                                ...
                                <span
                                    style="color:goldenrod; font-size:3rem; margin-top:2rem !important;font-weight:900; letter-spacing:1px !important;">Broad<span
                                        style="color:#fff; font-size:30px; font-weight:800; letter-spacing:1px;">trademining</span></span>
                            </a>
                        </div>
                        ...
                        <div class="header-nav navbar-collapse collapse ">
                            <ul class=" nav navbar-nav">
                                ...
                                <li style="padding-top: 2rem;" id="google_translate_element">
...
<div class="page-content">
                    ...
                    <div id="rev_slider_1014_1" class="rev_slider fullscreenbanner" style="display:none;"
                        ...
                        <ul>
                            ...
                            <li data-index="rs-1000" data-transition="slidingoverlayhorizontal"
                                ...
                                <div class="tp-caption   tp-resizeme" id="slide-100-layer-3"
                                    ...
                                    <div style="font-family: 'Poppins', sans-serif; text-transform:uppercase;">
                                        <span class="text-white" style="padding-right:10px;">Invest To</span><span
                                            class="text-primary"> Grow </span>
                                    </div>
                                ...
                                <div class="tp-caption   tp-resizeme" id="slide-100-layer-4"
                                    ...
                                    border-width:0px;">
                                    <div style="font-family: 'Poppins', sans-serif; text-transform:uppercase ;">
                                        <span class="text-primary" style="padding-right:10px;">Your</span><span
                                            class="text-white">Money</span>
                                    </div>
                                ...
                                <div class="tp-caption  tp-resizeme" id="slide-100-layer-5"
                                    ...
                                    color:#fff;
                                    border-width:0px;">
                                    <span style="font-family: 'Poppins', sans-serif;">Broadtrademining. is the
                                        most
                                        reliable and secure online platform that makes trading, investing easy and
                                        safe.</span>
                                </div>
                                ...
                                <div class="tp-caption tp-resizeme" id="slide-100-layer-6"
                                    ...
                                    <a href="/register" class="site-button slider-btn-left">Get Started</a>
                                </div>
                                ...
                                <div class="tp-caption tp-resizeme" id="slide-100-layer-7"
                                    ...
                                    font-weight:500;
                                    ">
                                    <!-- <a href="https://app.Broadtrademining..com/user/register" class="site-button white slider-btn-right">Sign Up</a> -->
                                </div>
                            ...
                            <li data-index="rs-1002" data-transition="slidingoverlayhorizontal"
                                ...
                                data-param8="" data-param9="" data-param10="" data-description="">
                                <!-- MAIN IMAGE -->
                                <img src="images/main-slider/slider2/slide2.jpg" alt="" data-bgposition="center bottom"
                                    data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina />
                                <!-- LAYERS -->
                                ...
                                <div class="tp-caption   tp-resizeme" id="slide-102-layer-3"
                                    ...
                                    <div style="font-family: 'Poppins', sans-serif; text-transform:uppercase; ">
                                        <span class="text-primary" style="padding-right:10px;">Digital</span><span
                                            class="text-white">Asset</span>
                                    </div>
                                ...
                                <div class="tp-caption   tp-resizeme" id="slide-102-layer-4"
                                    ...
                                    <div style="font-family: 'Poppins', sans-serif; text-transform:uppercase ;">
                                        <span class="text-white" style="padding-right:10px;">Easy Way</span><span
                                            class="text-primary">to Trade</span>
                                    </div>
                                ...
                                <div class="tp-caption  tp-resizeme" id="slide-102-layer-5"
                                    ...
                                    color:#fff;
                                    border-width:0px;">
                                    <span style="font-family: 'Poppins', sans-serif;">Start earning with our stable and
                                        goal-oriented investment programs </span>
                                </div>
                                ...
                                <div class="tp-caption tp-resizeme" id="slide-102-layer-6"
                                    ...
                                    data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]"
                                    data-paddingleft="[0,0,0,0]" style="z-index:13; text-transform:uppercase;">
                                    <a href="/register" class="site-button slider-btn-left">Start Earning</a>
                                </div>
    ...
    <!-- MARQUEE SCROLL -->
    <div
        style="width: 100%; height:62px; background-color: #1D2330; overflow:hidden; box-sizing: border-box; border: 1px solid #282E3B; border-radius: 4px; text-align: right; line-height:14px; block-size:62px; font-size: 12px; box-sizing:content-box; font-feature-settings: normal; text-size-adjust: 100%; box-shadow: inset 0 -20px 0 0 #262B38;padding:1px;padding: 0px; margin: 0px;">
        <div style="height:40px;"><iframe
                src="https://widget.coinlib.io/widget?type=horizontal_v2&amp;theme=dark&amp;pref_coin_id=1505&amp;invert_hover=no"
                width="100%" height="36" scrolling="auto" marginwidth="0" marginheight="0" frameborder="0" border="0"
                        ...
                        <div class="row">
                            <div class="col-md-9 col-sm-9">
                                <div class="call-to-action-left p-tb20 ">
                                    <h4 class="text-uppercase m-b10 font-weight-600">Invest in Digital Assets.</h4>
                                    <p>The platform carries over 100 tradable assets, unique risk management tools,
                                        advanced security protocols and 5 trading options: 60 sec, Speed trading, 24
                                        hrs, and Long term.Merit Invest Minner gives clients an exceptional
                                        trading
                                        experience and the adequate support they need in order to enhance their chances
                                        of success.
    ...
    <div class="section-full home-about-section p-t80 bg-no-repeat bg-bottom-right"
        style="background-image:url(images/background/bg-coin.png)">
                ...
                <div class="col-md-6">
                    <div class="wt-right-part p-b80">
                        ...
                        <div class="section-content">
                            <div class="wt-box">
                                <p>
                                    <strong>Broadtrademining. is place where traders can access real-world
                                        markets with
                                        crypto currencies and start trading instantly. We offer deposits and withdrawals
                                        via cryptos, overcoming the biggest hurdle letting traders instantly transact
                                        funds. By using cyrptos instead of fiat, we provide traders instant deposits,
                                        lightning fast execution, worldwide market access from around the globe, tight
                                        spreads and best client support.
                                    </strong>
                                </p>
                                <p>Our advanced trading robots made by our in house programming team, Our in house
                                    backtesting and strategy developer focus on dynamic trading environment. Our State
                                    of the Art AutoTrade bot technology (ATBT) is one of our most powerful trading robot
                                    for automated trading.</p>
                                <a href="/about" class="site-button text-uppercase m-r15">Read More</a>
                                <a href="/register" class="site-button-secondry text-uppercase">Invest Now</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-4 col-sm-4 step-number-block">
                        <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                            ...
                            <div class="icon-content">
                                ...
                                <h4 class="wt-tilte text-uppercase font-weight-500">Sign Up for Free</h4>
                                <p>Open an Account with just your email address, </ br> No verification documents
                                    required.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-sm-4 step-number-block">
                        <div class="wt-icon-box-wraper  p-a30 center bg-secondry m-a5 ">
                            ...
                            <div class="icon-content text-white">
                                ...
                                <h4 class="wt-tilte text-uppercase font-weight-500">Select a Package and Make Deposit
                                </h4>
                                <p>Choose from any of our plan that suite you. Fund your account with Bitcoins & more,
                                    No transfer fees charged..</p>
                            </div>
                        </div>
                    </div>
                    <!-- COLUMNS 3 -->
                    <div class="col-md-4 col-sm-4 step-number-block">
                        <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                            ...
                            <div class="icon-content">
                                ...
                                <p>Make profits from world’s most liquid markets with your preferred base currency &
                                    account type.</p>
                            </div>
                        </div>
                    </div>
    ...
    <div class="section">
        <div class="container">
            <h2 class="text-uppercase mt-5 text-center">A little info about Bitcoin</h2>
            <div class="row">
                <div class="col-md-8" style="margin: 2rem auto;">
                    <video width="100%;" controls style="margin: 2rem auto;">
    ...
    <div class="section-full p-t50 p-b50 overlay-wraper bg-parallax clouds1 bg-repeat"
        data-stellar-background-ratio="0.5" style="background-image:url(images/background/bg-9.jpg);">
            ...
            <div class="row">
                ...
                <div class="col-md-8 col-sm-8 mx-auto">
                    <div class="awesome-counter text-right text-white">
                        <h3 class="font-24">TheMerit Invest Minner</h3>
    ...
    <div class="section-full p-t80 p-b50">
        <div class="container">
            ...
            <div class="section-head text-center">
                ...
                <div id="no-more-tables">
                    <table
                        class="col-md-12 table-bordered table-striped table-condensed cf wt-responsive-table text-black">
                        <thead class="cf">
                            <tr>
                                <th>Members</th>
                                <th>Investment</th>
                        ...
                        <tbody>
                            <tr>
                                <td data-title="Members"><img
                                        src="noonecares.me/wp-content/uploads/2019/01/man-selfie-with-cheating-girlfriend-2.jpg"
                                        alt="" style="width:100px;height:100px;" class="p-r6"> </td>
                                <td data-title="Investment"><img src="images/coin-icon/bitcoin.png" class="p-r10"
                                        alt=""> Bitcoin</td>
                            ...
                            <tr>
                                ...
                                <td data-title="Members"><img
                                        src="miro.medium.com/max/1500/1_niATAZcFcK2hB5KvtIx_Ig.jpg" alt=""
                                        style="width:100px;height:100px;" class="p-r6"> </td>
                                <td data-title="Investment"><img src="images/coin-icon/bitcoin.png" class="p-r10"
                                        alt=""> Bitcoin</td>
                            ...
                            <tr>
                                <td data-title="Members"><img
                                        src="i2-prod.mirror.co.uk/incoming/article17421472.ece/ALTERNATES/s615b/0_PRIO-pics-to-be-added-still-Pair-killed-taking-selfie-named.jpg"
                                        alt="" style="width:100px;height:100px;" class="p-r6"> </td>
                                <td data-title="Investment"><img src="images/coin-icon/Ethereum.png" class="p-r10"
                                        alt=""> Ethereum</td>
                            ...
                            <tr>
                                <td data-title="Members"><img src="images/name.jpg" alt=""
                                        style="width:100px;height:100px;" class="p-r6"> </td>
                                <td data-title="Investment"><img src="images/coin-icon/litecoin.png" class="p-r10"
                                        alt=""> LiteCoin</td>
                            ...
                            <tr>
                                ...
                                <td data-title="Members"><img
                                        src="awesoroo.com/wp-content/uploads/2018/03/man-taking-a-selfie-mobile.jpg"
                                        alt="" style="width:100px;height:100px;" class="p-r6"> </td>
                                <td data-title="Investment"><img src="images/coin-icon/bitcoin.png" class="p-r10"
                                        alt=""> Bitcoin</td>
                            ...
                            <tr>
                                ...
                                <td data-title="Members"><img
                                        src="calebstorkey.com/wp-content/uploads/2014/03/Jo-Soda-No-Make-Up-Selfie-For-Cancer.png"
                                        alt="" style="width:100px;height:100px;" class="p-r6"> </td>
                                <td data-title="Investment"><img src="images/coin-icon/bitcoin.png" class="p-r10"
                                        alt="">Bitcoin</td>
                            ...
                            <tr>
                                ...
                                <td data-title="Members"><img src="i.redd.it/x3vk17k8mak21.png" alt=""
                                        style="width:100px;height:100px;" class="p-r6"> </td>
                                <td data-title="Investment"><img src="images/coin-icon/bitcoin.png" class="p-r10"
                                        alt=""> Bitcoin</td>
                            ...
                            <tr>
                                <td data-title="Members"><img src="images/name2.jpg" alt=""
                                        style="width:100px;height:100px;" class="p-r6"> </td>
                                <td data-title="Investment"><img src="images/coin-icon/litecoin.png" class="p-r10"
                                        alt=""> Litecoin</td>
                            ...
                            <tr>
                                <td data-title="Members"><img
                                        src="e3.365dm.com/20/04/768x432/30be3fc0f46a0b6e0c987f5c066567372cac7f957c6854b6e97bf78daa8d14dc_497627951ab51ab.jpg?20200424174245"
                                        alt="" style="width:100px;height:100px;" class="p-r6"> </td>
                                <td data-title="Investment"><img src="images/coin-icon/bitcoin.png" class="p-r10"
                                        alt=""> Bitcoin</td>
                            ...
                            <tr>
                                <td data-title="Members"><img
                                        src="www.superprof.ng/images/teachers/teacher-home-year-old-man-with-bachelors-math-extensive-tutoring-experience-and-patience-wants-help-people-with-algebra-geometry.jpg"
                                        alt="" style="width:100px;height:100px;" class="p-r6"> </td>
                                <td data-title="Investment"><img src="images/coin-icon/bitcoin.png" class="p-r10"
                                        alt=""> Bitcoin</td>
            ...
            <marquee direction="down" height="100%">
                <table class="table" style="width: 100%;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="text-center"><button class="btn2"><span class="btn-label"><i
                                            class="fa fa-warning"></i></span>Pending</button></td>
                        ...
                        <tr>
                            <td class="text-center"><button class="btn btn-info btn-sm"><span class="btn-label"><i
                                            class="fa
                                            fa-check"></i></span>Confirmed</button></td>
        ...
        <section class="parallax_one padding" style="background-position: 50% -432px; background:lightgray;">
            <div class="container">
                <div class="row">
                    <div class="col-sm-6">
                        <figure>
                            <img src="images/demo2.png" alt="Good Plans" class="img-responsive">
                        </figure>
                    </div>
                    <div class="col-sm-5" style="background-color: #fff; border-radius:1rem; margin:10px;">
                        <div class="bg_call border_radius wow fadeInRight animated" id="callform" data-wow-delay="500ms"
                            style="border-radius:30px;visibility: visible; animation-delay: 500ms; animation-name: fadeInRight;">
                            <h2 class="bottom10 text-center">Profit <span class="text-info">Calculator </span></h2>
                            <p class="text-center bottom20">If you need to calculate how much profit you will make from
                                your
                                investment, kindly use the profit calculator below.</p>
                            <form class="callus" method="GET" onsubmit="return getProfit()">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 form-group">
                                        <div class="select border_radius">
                                            <select id="package" required="" class="form-control">
                                                <option value="">Select Package</option>
                                                <option value="0">Starter Plan</option>
                                                <option value="1">Premium Plan</option>
                                                <option value="2">Deluxe Plan</option>
                                    ...
                                    <div class="col-sm-12 form-group">
                                        <div class="select border_radius">
                                            <select id="discuss" class="form-control">
                                                ...
                                                <option value="skrill">Skrill payment</option>
                                                <option value="payeer">Payeer Wallet</option>
                                                <option value="perfect">Perfect Money</option>
                                            </select>
                                        </div>
                                        <button type="submit"
                                            class="btn btn-block btn-green top10 border_radius text-uppercase">Submit</button>
                                    </div>
                                    <div class="col-md-12">
                                        <h5 class="text-white mt-5" id="profit"></h5>
                                    </div>
                                </div>
                            </form>
                        </div>
        ...
        <div class="m-b100">
            ...
            <h2 style="text-align:center; margin-bottom:4rem; margin-top:3rem; font-weight: 700; color:goldenrod;">
                Trading Plans</h2>
            <hr>
            <!-- PRICING STYLE-1 COLUMNS 4 WITH NO GAP -->
            <div class="section-content">
                            ...
                            <div class="pricingtable-wrapper">
                                <div class="pricingtable-inner">
                                    ...
                                    <div class="pricingtable-price">
                                        <span class="pricingtable-bx">$500+</span>
                                    </div>

                                    <ul class="pricingtable-features">
                                        <li><i class="fa fa-check"></i>$500- $2000 Deposit</li>
                                        <li><i class="fa fa-check"></i>Minimum $3000 - $6000 expected return </li>
                                        <li><i class="fa fa-check"></i> Full access to all features </li>
                                        <li><i class="fa fa-check"></i> More than 75 assets </li>
                                        <li><i class="fa fa-check"></i> 17% Hourly Profit</li>
                                        <li><i class="fa fa-check"></i> Withdrawal takes less than 48 hours to process
                                        </li>
                                        <li><i class="fa fa-check"></i> Personal account manager</li>
                                        <li><i class="fa fa-check"></i> Withdrawal fees: &nbsp;2% </li>
                                        <li><i class="fa fa-check"></i> Plan Duration: 1 MONTH </li>
                                    </ul>

                                    <div class="pricingtable-footer">
                                        <a href="/register" class="site-button  text-uppercase">Open Account</a>
                                    </div>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 m-b40">
                            <div class="pricingtable-wrapper">
                                <div class="pricingtable-inner pricingtable-highlight">
                                    ...
                                    <div class="pricingtable-price">
                                        <span class="pricingtable-bx">$2000+</span>
                                    </div>

                                    <ul class="pricingtable-features">
                                        <li><i class="fa fa-check"></i>$2000 - $9000 Deposit</li>
                                        <li><i class="fa fa-check"></i>Minimum $10,000 - $50,000 expected return </li>
                                        <li><i class="fa fa-check"></i> Full access to all features </li>
                                        <li><i class="fa fa-check"></i> More than 75 assets </li>
                                        <li><i class="fa fa-check"></i> 32% Hourly Profit</li>
                                        <li><i class="fa fa-check"></i> Withdrawal takes less than 48 hours to process
                                        </li>
                                        <li><i class="fa fa-check"></i> Personal account manager</li>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 m-b240">
                            <div class="pricingtable-wrapper">
                                <div class="pricingtable-inner">
                                    ...
                                    <ul class="pricingtable-features">
                                        <li><i class="fa fa-check"></i>$10,000 - $50,000 Deposit</li>
                                        <li><i class="fa fa-check"></i>Minimum $50,000 - $120,000 expected return </li>
                                        <li><i class="fa fa-check"></i> Full access to all features </li>
                                        <li><i class="fa fa-check"></i> More than 75 assets </li>
                                        <li><i class="fa fa-check"></i> 6.5% Daily Profit</li>
                                        <li><i class="fa fa-check"></i> Withdrawal takes less than 48 hours to process
                                        </li>
                                        <li><i class="fa fa-check"></i> Personal account manager</li>
                                        <li><i class="fa fa-check"></i> Withdrawal fees: &nbsp;5% </li>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 m-b40">
                            <div class="pricingtable-wrapper">
                                <div class="pricingtable-inner">
                                    ...
                                    <div class="pricingtable-price">
                                        <span class="pricingtable-bx">$50,000+</span>
                                    </div>

                                    <ul class="pricingtable-features">
                                        <li><i class="fa fa-check"></i>$50,000 - (ABOVE)$100,0000+ Deposit</li>
                                        <li><i class="fa fa-check"></i>Minimum $110,000 - $500,000 expected return </li>
                                        <li><i class="fa fa-check"></i> Full access to all features </li>
                                        <li><i class="fa fa-check"></i> More than 75 assets </li>
        ...
        <div class="section-full p-t80 p-b50 bg-center bg-full-height bg-no-repeat"
            style="background-image:url(images/background/bg-testimonial.jpg);">
            <div class="container">
                <!-- TITLE START -->
                <div class="section-head text-center">
                            ...
                            <div class="testimonial-5">
                                ...
                                <div class="testimonial-text clearfix">
                                    <div class="testimonial-paragraph">
                                        ...
                                        <p>Thanks to James Chris forex trader and his team, This is the real definition
                                            of being top notch. I literally watched my account blossom into what it is
                                            today.
                            ...
                            <div class="testimonial-5">
                                ...
                                <div class="testimonial-text clearfix">
                                    <div class="testimonial-paragraph">
                                        <span class="fa fa-quote-left text-primary"></span>
                                        <p>
                                            I really did not think it was possible before until MR AARON GRAHAM
                                            introduced me now to make so much profit, but here I am right now, so
                                            excited.
                            ...
                            <div class="testimonial-5">
                                ...
                                <div class="testimonial-text clearfix">
                                    <div class="testimonial-paragraph">
                                        <span class="fa fa-quote-left text-primary"></span>
                                        <p>
                                            This is just incredible and just when I think its good enough, it just keeps
                                            getting better. Made over 4 withdarwals.
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="widget widget_about">
                        ...
                        <div class="logo-footer clearfix p-b15">
                            <h4>Broadtrademining</h4>
                        </div>
                        <p>This website is not directed at any jurisdiction and is not intended for any use that would
                            be contrary to local law or regulation.<br> Risk Warning: Trading leveraged products such as
                            Forex and CFDs may not be suitable for all investors as they carry a high degree of risk to
                            your investment. Before deciding to trade any such leveraged products you should carefully
                            consider your investment objectives, level of experience, and risk appetite, and if
                            necessary seek independent advice to full understand the risk involved
                        </p>
                    </div>
                </div>
        ...
        <div class="container p-t30">
            <div class="row">
                <div class="wt-footer-bot-left">
                    <span class="copyrights-text">© 2024 Broadtrademining All Rights Reserved.</span>
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body p-a30">
                <form id="log-form">
                    ...
                    <span class="font-12">Don't have an account? <a href="Broadtrademining.com" class="text-primary">Register
                            Here</a></span>
                </form>
            </div>
            <div class="modal-footer text-center">
                <div class="text-center"><img src="images/logo/logo.php" alt=""></div>
            </div>
        </div>
    </div>
</div>
...
<div class="preloader preloader-alt no-split"><span class="spinner spinner-alt"
        style=" display: flex; align-items: center; justify-content: center; text-align: center; color:#fff;">
        <!-- <img class="spinner-brand" src="tenor.gife" alt="nova wave Trade"> -->
        <h4 style="color:#fff; font-weight:900; font-size:30px;">Broad<br>
            <span style="color:goldenrod;">trademining</span>
        </h4>
    </span></div>
...
function getProfit() {
    ...
    var package = document.getElementById("package").value * 1;
    var mins = [1000, 5000, 15000, 25000];
    var maxs = [4999, 14999, 24999, 1000000];
    var percents = [2, 3, 3.7, 4.2];
    var packages = ["Amateur", "Starter", "Basic", "Standard"];
    var min = mins[package];
    var max = maxs[package];

    if (amount >= min && amount <= max) {
        document.getElementById("profit").innerHTML =
            `Expected profit after 4 days is: <strong class="text-success">$` + (((percents[package] /
                    100) * 30 *
                amount) + amount) + `</strong>`
    } else {
        document.getElementById("profit").innerHTML = "<span class=\'text-danger\'>For " + packages[
                package] +
            " Package, Minimum is: $" + min + " and Maximum is: $" + max + "</span>";
    }


    console.log(amount + " We want to calculate porofit " + min);
